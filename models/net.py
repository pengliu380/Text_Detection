...
class SSD300(nn.Module):
    ...
    box_sizes = (30, 60, 111, 162, 213, 264, 315)  # 315 is extra, default bounding box sizes for each feature map.
    aspect_ratios = ((2,3,5,7,10), (2,3,5,7,10), (2,3,5,7,10), (2,3,5,7,10), (2,3,5,7,10), (2,3,5,7,10))
    fm_sizes = (38, 19, 10, 5, 3, 1) # w * h

    def __init__(self, num_classes):
        super(SSD300, self).__init__()
        self.num_classes = num_classes # default 2, is word or not
        self.num_anchors = (14, 14, 14, 14, 14, 14) # each location 14 anchors
        ...
        for i in range(len(self.in_channels)):
        	...
        	self.cls_layers += [nn.Conv2d(self.in_channels[i], self.num_anchors[i]*self.num_classes, kernel_size=(1,5), padding=(0,2))]
